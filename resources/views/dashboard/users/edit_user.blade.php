...
@section('content')
    <form action="{{ route('dashboard.user.profile.update', ['user' => $user->id]) }}" method="post"
        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                <img src="{{ $user->profileImageUrl() }}" class="d-block my-2 img-circle elevation-2 mx-auto"
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control  s @error('name') is-invalid @enderror" id=""
                        placeholder="Enter username" name='name' value="{{ $user->name }}">
                </div>
                <div class="form-group">
